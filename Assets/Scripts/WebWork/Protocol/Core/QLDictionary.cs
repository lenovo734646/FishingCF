...
namespace QL.Core
{
    ...
    /// 符合QL习惯的纯字符串字典结构。
    /// </summary>
    public class QLDictionary : Dictionary<string, string>
    {
        public QLDictionary() { }

        public QLDictionary(IDictionary<string, string> dictionary)
            : base(dictionary)
        { }
        ...
        public void Add(string key, object value)
        {
            ...
            else if (value is Nullable<DateTime>)
            {
                ...
                strValue = dateTime.Value.ToString(QLConstants.DATE_TIME_FORMAT);
            }
